...
适用于对话荧光笔 v0.4.1，更新日期：2026-09-06。

- 扩展在你授权的 ChatGPT 页面读取对话文字、选区和页面结构，以显示高亮、定位批注及整理 PDF。
- 保存的数据包括选中的原文、上下文、批注、颜色、对话地址、定位信息和工具位置。这些数据保存在本机的扩展存储中，不提供云同步。
...
- PDF 在本机的新标签页中整理，随后调用浏览器打印。预览可能向原始地址请求对话中的图片。扩展不创建公开分享链接。
...
- 下载网站不设置分析或广告追踪，也没有注册表单。网站与下载服务提供商（Sites、GitHub）可能按其服务规则处理网络访问日志。
