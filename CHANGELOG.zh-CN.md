...
## v0.6.0 · 2026-09-07 · 支持 Chrome

- 新增电脑版 Chrome ZIP，与 Safari 共用同一套功能代码，包含高亮、批注、快捷手势、激光笔、批量整理、备份及两种 PDF 导出。
- 修复 PDF 预览只读取 Safari 扩展存储的问题，现在同时支持 Chrome。
- 保留本地公式排版、中英文切换和默认英文。
- 新增中英文 Chrome 安装说明及跨浏览器笔记迁移步骤。
- 网站分别提供 Chrome 和 Safari 下载入口。
- 验证：74 项自动化测试通过，含两种浏览器 API 下的 PDF 预览与弹窗检查。Chrome 实机测试尚未完成。

## v0.5.1 · 2026-09-06 · 默认英文

- 网站、插件、Safari 弹窗、PDF 预览、Mac 应用和安装说明首次打开默认英文。
- GitHub 首页、安装、隐私和版本说明默认展示英文，顶部可进入中文页面；旧版英文链接继续可用。
- 保留中文切换和已保存的语言选择，不改变对话原文、批注或公式。
